...
var require_react_development = __commonJS((exports, module) => {
  ...
  exports.Profiler = undefined;
  exports.PureComponent = undefined;
  exports.StrictMode = undefined;
  exports.Suspense = undefined;
  exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = undefined;
  exports.cloneElement = undefined;
  exports.createContext = undefined;
  exports.createElement = undefined;
  exports.createFactory = undefined;
  ...
  exports.startTransition = undefined;
  exports.unstable_act = undefined;
  exports.useCallback = undefined;
  exports.useContext = undefined;
  exports.useDebugValue = undefined;
  exports.useDeferredValue = undefined;
  exports.useEffect = undefined;
  exports.useId = undefined;
  exports.useImperativeHandle = undefined;
  exports.useInsertionEffect = undefined;
  exports.useLayoutEffect = undefined;
  exports.useMemo = undefined;
  exports.useReducer = undefined;
  exports.useRef = undefined;
  exports.useState = undefined;
  exports.useSyncExternalStore = undefined;
  exports.useTransition = undefined;
...
var $AsyncMode, $ConcurrentMode, $ContextConsumer, $ContextProvider, $Element, $ForwardRef, $Fragment, $Lazy, $Memo, $Portal, $Profiler, $StrictMode, $Suspense, $isAsyncMode, $isConcurrentMode, $isContextConsumer, $isContextProvider, $isElement, $isForwardRef, $isFragment, $isLazy, $isMemo, $isPortal, $isProfiler, $isStrictMode, $isSuspense, $isValidElementType, $typeOf;
...
var require_prop_types = __commonJS((exports, module) => {
  ...
  module.exports = require_factoryWithTypeCheckers()($isElement, throwOnDirectAccess);
  var throwOnDirectAccess;
});

// src/components/IdealImage/index.tsx
var import_react3 = __toESM(require_react_development());
...
var import_react = __toESM(require_react_development());

// node_modules/react-is/cjs/react-is.development.js
var $ContextConsumer2;
var $ContextProvider2;
var $Element2;
var $ForwardRef2;
var $Fragment2;
var $Lazy2;
...
var $SuspenseList;
var $isAsyncMode2;
var $isConcurrentMode2;
var $isContextConsumer2;
var $isContextProvider2;
var $isElement2;
var $isForwardRef2;
var $isFragment2;
var $isLazy2;
...
var Waypoint = function(_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    if (isDOMElement(children) || $isForwardRef2(children)) {
...
var import_react2 = __toESM(require_react_development());
...
var React2 = __toESM(require_react_development());
var $Fragment3;
var $jsx;
var $jsxs;
(function() {
...
var Media = ({
  ...
  const [dimensionElement, setDimensionElement] = import_react2.useState(null);
  const renderIcon = (useProps2) => {
    const { icon, icons: icons3, iconColor: fill, iconSize: size, theme: theme3 } = useProps2;
    const iconToRender = icons3[icon];
    if (!iconToRender)
      return null;
    const styleOrClass = composeStyle_default({ width: size + 100, height: size, color: fill }, theme3.icon);
    return import_react2.default.createElement("div", styleOrClass, [
      import_react2.default.createElement(iconToRender, { fill, size, key: "icon" }),
      import_react2.default.createElement("br", { key: "br" }),
      useProps2.message
    ]);
  };
  const renderImage = (useProps2) => {
    return useProps2.icon === loaded2 ? $jsx("img", {
      ...composeStyle_default(useProps2.theme.img),
      src: useProps2.src,
      alt: useProps2.alt,
  ...
  const renderNoscript = (useProps2) => {
    return useProps2.ssr ? $jsx("noscript", {
      children: $jsx("img", {
        ...composeStyle_default(useProps2.theme.img, useProps2.theme.noscript),
        src: useProps2.nsSrc,
        srcSet: useProps2.nsSrcSet,
        alt: useProps2.alt,
        width: useProps2.width,
        height: useProps2.height
      })
  ...
  return $jsx("div", {
    ...composeStyle_default(useProps.theme.placeholder, background, useProps.style, useProps.className),
...
var IdealImage = ({
  ...
  const load3 = (userTriggered) => {
    ...
    loadStateChange(loading3, userTriggered);
    const newLoader = loader === "xhr" ? xhrLoader(url) : imageLoader(url);
    newLoader.then(() => {
      clear();
      loadStateChange(loaded3, false);
    }).catch((e) => {
      clear();
      if (e.status === 404)
        loadStateChange(error3, false, 404);
      else
        loadStateChange(error3, false);
    });
    if (threshold) {
  ...
  const onLeave2 = () => {
    if (state.loadState === loading3 && !state.userTriggered) {
...
var IdealImageWithDefaults = (props) => $jsx(IdealImage_default, {
  ...props
});
